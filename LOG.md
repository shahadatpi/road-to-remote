...
- **Day 2 (2026-06-02)** - Closely Understood The Closure and Clear the confusion between global scope and modular scope in execution context With `queue.js` in my project.  Wrote `notes/js-closure.md`. Also wrote leetcode contains-duplicate in `dsa/contains-duplicate`
- 